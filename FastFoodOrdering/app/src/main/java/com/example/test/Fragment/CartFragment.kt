...
import com.example.test.CongratsBottomSheet
import com.example.test.PayOutActivity
...
class CartFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val cartFoodName = listOf("Burger","Fried chicken","Coca Cola","Potato chips")
        val cartItemPrice = listOf("$5", "$10", "$8", "$9")
