...
import com.example.test.Adapter.PopularAdapter
import com.example.test.MenuBootomSheetFragment
...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val foodName = listOf("Burger", "Fried Chicken", "potato chips", "Coca Cola")
